...
/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module getsockname shall be considered present. */
#define GNULIB_GETSOCKNAME 1
...
#define PACKAGE_STRING "wget 1.25.0"
...
/* Define to an expression equivalent to <time.h> daylight if <time.h>
   __daylight does not already do that. */
/* #undef __daylight */
